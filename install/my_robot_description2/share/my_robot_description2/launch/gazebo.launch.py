...
def generate_launch_description(): 
    ...
    model2_arg = DeclareLaunchArgument(
        name = "model2",
        default_value = os.path.join(get_package_share_directory("my_robot_description2"),"urdf","robot_description.urdf.xacro"),
        description = "Absolute path to robot URDF file"
    )


    robot_description = ParameterValue(Command(["xacro ", LaunchConfiguration("model2")]), value_type=str)
    ...
    spawn_robot = Node(
         ...
         arguments=["-entity", "robot_name2","-topic", "robot_description"],
         output="screen"
    )
    ...
    return LaunchDescription([ model2_arg,
